...
class CourseFixtures extends Fixture
{
    ...
    {
        // course-0: бесплатный (Изучение Symfony)
        $free1 = new Course();
        ...
        // course-2: покупка (Модель данных)
        $buy = new Course();
